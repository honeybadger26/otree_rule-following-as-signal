...
SESSION_CONFIGS = [
    ...
    {
        'name': 'thesis',
        'display_name': "Thesis (Complete)",
        'num_demo_participants': 4,
        'app_sequence': ['thesis_instructions', 'thesis', 'svotree', 'thesis_demographics', 'thesis_debriefing',
                         'payment_info'],
    },
    {
        'name': 'svotree',
    ...
    {
        'name': 'thesis_demographics',
        'display_name': "Thesis General Questions",
        'num_demo_participants': 1,
        'app_sequence': ['thesis_demographics'],
    },
    {
        'name': 'thesis_debriefing',
        'display_name': "Thesis Debriefing",
        'num_demo_participants': 1,
        'app_sequence': ['thesis_debriefing'],
    },
    {
        'name': 'payment_info',
